...
abstract class $SideBarModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String label, StepStatus status, Widget formWidget});
}
...
class _$SideBarModelImpl implements _SideBarModel {
  ...
  @override
  String toString() {
    return 'SideBarModel(title: $title, label: $label, status: $status, formWidget: $formWidget)';
  }
...
abstract class _SideBarModel implements SideBarModel {
  const factory _SideBarModel(
      ...
      required final Widget formWidget}) = _$SideBarModelImpl;
